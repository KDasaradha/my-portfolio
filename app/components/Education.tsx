          ...
          {educationDetails.map((edu, index) => (
            ...
            >
              <Card className="hover:shadow-lg transition-all duration-300">
                ...
                <CardContent>
                  <p className="text-gray-600 dark:text-gray-300">{edu.course}</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-2">{edu.duration}</p>

                  {/* Location */}
                  <div className="flex items-center gap-2 mt-4">
                    <FaMapMarkerAlt className="text-red-500" />
                    <a href={edu.mapsLink} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline text-sm">
                      {edu.location}
                    </a>
                  </div>
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    ...
                    <a href={edu.website} target="_blank" rel="noopener noreferrer" className="text-blue-500 hover:underline text-sm">
                      Visit Website
                    </a>
                  </div>
                </CardContent>
